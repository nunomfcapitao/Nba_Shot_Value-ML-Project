...
st.sidebar.markdown('The dataset used contains the shot logs of 480 different NBA players from the regular 2014/2015 season')
st.sidebar.markdown("Dataset: https://www.kaggle.com/dansbecker/nba-shot-logs")
